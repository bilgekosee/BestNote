      ...
      <ul className="slider" ref={slider}>
        ...
        >
          <div className="content">
            ...
            <p className="description">
              ...
              bilgisayarlarımızda kullandığımız web sitelerinin oluşturulmasında
              kullanılır. Chrome, Fİrefox ve İnternet Explorer gibi tarayıcılar
              html kodlarını işleyerek bu kodları web sayfasına dönüştürür.
            </p>
        ...
        >
          <div className="content">
            ...
            <p className="description">
              ...
              anlamına gelen web sayfalarında “yazı tipi, renk, boyut, arka plan
              ve dokular” gibi ögelerde arzu edilen değişiklikleri tanımlamanızı
        ...
        >
          <div className="content">
            ...
            <p className="description">
              ...
              ve sunucular geliştirirken kullandıkları dinamik hafif bir
              programlama dilidir. JavaScript kullanarak etkileşimli ve dinamik
              web sayfaları geliştirilir. Yazılım geliştiriciler tarafından en
              yaygın kullanılan temel yazılım dillerinin başında gelmektedir.
            </p>
            <button>Read More</button>
          </div>
        </li>
        ...
        >
          <div className="content">
            ...
            <p className="description">
              ...
              belirli yapı ve işlevsellikleri hazır olarak sunan bir altyapıdır.
              Framework’ler, yazılım geliştirme sürecini hızlandırmak ve
              kolaylaştırmak için çeşitli fonksiyonlar, kütüphaneler ve yapı
              taşı kodlarla birlikte gelir. Yazılımcılar, sıfırdan her şeyin
              kodunu yazmak yerine, bu hazır yapıları kullanarak projelerini
              daha hızlı ve düzenli bir şekilde oluşturabilirler.
            </p>
            <button>Read More</button>
          </div>
        </li>
        ...
        >
          <div className="content">
            ...
            <p className="description">
              Kod değişikliklerini takip eden ve geliştirme sürecini düzenleyen
              sistemler sayesinde ekipler, proje üzerinde uyumla çalışır. DevOps
              araçları ise, kodun testten geçip hızlıca canlı ortama
              aktarılmasını sağlar, böylece yazılım geliştirme süreci daha
              güvenilir ve verimli hale gelir.
            </p>
            <button>Read More</button>
          </div>
        </li>
